 ...
 shelfnos_id_fm numeric(22.0,0.0 )   not null ,
 gno_shpord varchar(40)   ,
 qty_shortage numeric(22.0,6.0 )   ,
 masterprice numeric(38.0,4.0 )   ,
 id numeric(38.0,0.0 )   not null  ,
 remark varchar(4000)   ,
 expiredate date  ,
 update_ip varchar(40)   ,
 created_at timestamp(6)  ,
 updated_at timestamp(6)  ,
 persons_id_upd numeric(38.0,0.0 )   not null ,
 itms_id numeric(38.0,0.0 )   not null ,
 price numeric(38.0,4.0 )   ,
 amt numeric(18.0,4.0 )   ,
 sno varchar(50)   ,
 duedate timestamp(6)  ,
 isudate timestamp(6)  ,
 contents varchar(4000)   ,
 depdate timestamp(6)  ,
 tax numeric(38.0,4.0 )   ,
 cartonno varchar(50)   ,
 processseq numeric(38.0,0.0 )   ,
 prjnos_id numeric(38.0,0.0 )   not null ,
 lotno varchar(50)   ,
 qty_stk numeric(22.0,6.0 )   ,
 units_id_case_shp numeric(38.0,0.0 )   not null ,
 qty_case numeric(22.0,6.0 )   ,
 cno varchar(40)   ,
 packno varchar(10)   ,
 rcptdate timestamp(6)  ,
 contractprice char(1)   ,
 gno varchar(40)   ,
 chrgs_id numeric(38.0,0.0 )   not null ,
 taxrate numeric(2.0,0.0 )   ,
 crrs_id numeric(22.0,0.0 )   not null ,
 paretblname varchar(30)   ,
 box varchar(50)   ,
 paretblid numeric(38.0,0.0 )   ,
 transports_id numeric(38.0,0.0 )   not null ,
 shelfnos_id_to numeric(38.0,0.0 )   not null ,
 qty_real numeric(22.0,6.0 )   ,
